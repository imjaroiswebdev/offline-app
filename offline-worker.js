...
(function (self) {
  ...
  var oghliner = self.oghliner = {
    ...
    CACHE_PREFIX: 'offline-cache:imjaroiswebdev/offline-app:' + (self.registration ? self.registration.scope : '') + ':',

    // This is the unique name for the cache controlled by this version of the worker.
    get CACHE_NAME() {
      return this.CACHE_PREFIX + '2f3f9d3f26f04547ad153f6a943b4d00636eb314';
    },
    ...
    RESOURCES: [
      ...
      './images/apple-touch-icon-144x144.png', // bee616044c2c14e55035c2bb2da17d1fc1e5ad93
      ...
      './images/apple-touch-icon-72x72.png', // 81f019f8de7bf48c747bd66eae29054691a69d2d
      ...
      './images/favicon-96x96.png', // a33ae33d47d475d23a9920ebb2ae03ec06b98bc0
      './images/mstile-144x144.png', // 4146685ffdb97a94dcd9efc0c63c8a724ba80dd4
      ...
      './images/mstile-70x70.png', // acca7a10e57ce8b695b5b122747a152a26d062bd
      './index.html', // 8bde75fac66e53336190c3f69104522992ba2731
